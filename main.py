...
if __name__ == "__main__":
    ...
    if len(sys.argv) == 1:
        print(Fore.CYAN + "=" * 50)
        print(Fore.YELLOW + "🐱 傲娇猫娘小雫 - 运行模式选择")
        print(Fore.CYAN + "=" * 50)
        print(Fore.GREEN + "0: 映射至Koishi (OpenAI API兼容)")
        ...
        while True:
            try:
                # 调整可选项
                choice = input(Fore.YELLOW + "请选择模式 (0/1/2/3): ").strip()
        ...
        try:
            ...
            print(Fore.RED + "无效的命令行参数。请使用 0, 1, 2 或 3 指定模式")
